[![Brest Rolling Scopes](http://anastasiya-maximovich.com/images/logo_rs_text.svg)](http://anastasiya-maximovich.com/)
#Brest Rolling Scopes School
## Javascript Assignments  [![Build Status](https://travis-ci.org/anastasiya-maximovich/js-assignments.svg?branch=master)](https://travis-ci.org/anastasiya-maximovich/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of anastasiya-maximovich with your account name).
